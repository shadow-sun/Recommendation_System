...
class FaissIndexer:
    def __init__(self, dim: int = 64, index_type: Optional[str] = None, nlist: int = 256):
        self.dim = dim
    ...
    def build(self, item_ids: List[str], embeddings: np.ndarray) -> "FaissIndexer":
    ...
    def search(self, query_embeddings: np.ndarray, k: int = 500, exclude_ids: Optional[List[str]] = None) -> List[List[Tuple[str, float]]]:
